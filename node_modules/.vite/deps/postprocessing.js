...
var EffectComposer = class {
	...
	*/
	deleteDepthTexture() {
		...
		(_a = this.depthRenderTarget) == null || _a.dispose();
		this.depthRenderTarget = null;
		(_b = this.inputBuffer.depthTexture) == null || _b.dispose();
		this.inputBuffer.depthTexture = null;
		(_c = this.outputBuffer.depthTexture) == null || _c.dispose();
